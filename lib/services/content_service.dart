    ...
    switch (pageName.toLowerCase()) {
      ...
      case 'events':
        return {
          'events': [
            {
              'title': 'Morning Celebration',
              'time': 'Sunday, 11:00 – 12:15',
              'description': 'Our main worship service for all ages.',
              'location': 'Main Sanctuary',
              'recurring': true,
            },
            {
              'title': 'Junior Church',
              'time': 'Sunday, 11:30 – 12:15',
              'description': 'Children’s group for toddlers and primary school during the service.',
              'location': 'Kids Room',
              'recurring': true,
            },
            {
              'title': 'HUB Cafe',
              'time': 'Monday, 10:00 – 12:30',
              'description': 'Community cafe open to all.',
              'location': 'Cafe Area',
              'recurring': true,
            },
            {
            ...
            },
            {
              ...
              'description': 'Prayer and Bible Study for all.',
              'location': 'Main Sanctuary',
              'recurring': true,
            },
            {
            ...
            {
              'title': 'Warrior Women',
              'time': 'Wednesday, 19:00 – 20:30 (last Wednesday of the month)',
              'description': 'Women’s group for fellowship and encouragement.',
              'location': 'Main Sanctuary',
              'recurring': true,
            },
            {
