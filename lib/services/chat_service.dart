...
class ChatService with ChangeNotifier {
  ...
  Future<void> sendMessage(ChatMessage message) async {
    ...
    try {
      ...
      final safeReply = reply ?? 'I want to give a meaningful, Bible-based answer, but I did not find a direct match. Ask a verse like "John 3:16" or a question such as "Who is Jesus?" and I will help.';
      ...
      _messages.add(ChatMessage(
        ...
        senderId: 'nlcchat',
        role: 'NLCChat',
        content: 'I hit a snag while answering. Please try asking again about a Bible verse (e.g., "John 3:16") or a topic like salvation, prayer, or Jesus.',
        timestamp: DateTime.now(),
        attachments: const [],
        escalated: false,
      ));
  ...
  Future<String?> _buildReply(String text) async {
    ...
    if (lower.contains('hello') || lower.contains('hi ') || lower.startsWith('hi') || lower.contains('hey')) {
    ...
    if (lower.contains('salvation') || lower.contains('saved') || lower.contains('born again')) {
    ...
    final preview = text.length > 50 ? '${text.substring(0, 47)}...' : text.trim();
  ...
  Future<String?> _tryFetchBibleVerse(String text) async {
    // Match patterns like "John 3:16", "Psalm 23", "Genesis 1:1", etc.
    final versePattern = RegExp(r'(\d?\s?[a-z]+)\s+(\d+)(?::(\d+))?', caseSensitive: false);
    ...
    if (match != null) {
      ...
      try {
        ...
        print('Bible verse fetch failed: $e');
      }
    }
  ...
  Future<String?> _tryBibleSearch(String text) async {
    ...
    // Old Testament Books
    if (lower.contains('genesis') || lower.contains('garden of eden') || lower.contains('adam and eve')) {
    ...
    if (lower.contains('exodus') || lower.contains('ten commandments') || lower.contains('red sea')) {
    ...
    if (lower.contains('leviticus') || lower.contains('sacrifices') || lower.contains('priesthood')) {
    ...
    if (lower.contains('joshua') || lower.contains('jericho') || lower.contains('promised land')) {
    ...
    if (lower.contains('judges') || lower.contains('samson') || lower.contains('gideon') || lower.contains('deborah')) {
    ...
    if (lower.contains('ruth') || lower.contains('boaz') || lower.contains('kinsman redeemer')) {
    ...
    if (lower.contains('samuel') || lower.contains('1 samuel') || lower.contains('2 samuel')) {
    ...
    if (lower.contains('kings') || lower.contains('1 kings') || lower.contains('2 kings') || lower.contains('elijah') || lower.contains('elisha')) {
    ...
    if (lower.contains('chronicles') || lower.contains('1 chronicles') || lower.contains('2 chronicles')) {
    ...
    if (lower.contains('ezra') || lower.contains('nehemiah') || lower.contains('rebuilding')) {
    ...
    if (lower.contains('esther') || lower.contains('mordecai') || lower.contains('purim')) {
    ...
    if (lower.contains('psalms') || lower.contains('psalm') || lower.contains('worship songs')) {
    ...
    if (lower.contains('ecclesiastes') || lower.contains('meaningless') || lower.contains('vanity')) {
    ...
    if (lower.contains('ezekiel') || lower.contains('dry bones') || lower.contains('valley of dry bones')) {
    ...
    if (lower.contains('daniel') || lower.contains('lion') || lower.contains('fiery furnace')) {
    ...
    if (lower.contains('jonah') || lower.contains('whale') || lower.contains('nineveh')) {
    ...
    if (lower.contains('john') && (lower.contains('gospel') || lower.contains('3:16'))) {
    ...
    if (lower.contains('acts') || lower.contains('early church') || lower.contains('pentecost')) {
    ...
    if (lower.contains('corinthians') || lower.contains('1 corinthians') || lower.contains('2 corinthians') || lower.contains('love chapter')) {
    ...
    if (lower.contains('philippians') || lower.contains('joy') || lower.contains('rejoice')) {
    ...
    if (lower.contains('thessalonians') || lower.contains('1 thessalonians') || lower.contains('2 thessalonians') || lower.contains('second coming')) {
    ...
    if (lower.contains('timothy') || lower.contains('1 timothy') || lower.contains('2 timothy') || lower.contains('pastoral')) {
    ...
    if (lower.contains('peter') || lower.contains('1 peter') || lower.contains('2 peter')) {
    ...
    if (lower.contains('1 john') || lower.contains('2 john') || lower.contains('3 john') || lower.contains('epistles of john')) {
    ...
    if (lower.contains('revelation') || lower.contains('apocalypse') || lower.contains('end times') || lower.contains('seven seals')) {
    ...
    // Biblical characters
    if (lower.contains('who is jesus') || lower.contains('tell me about jesus')) {
  ...
  Future<String?> _searchInternet(String query) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        if (definition != null && definition.toString().trim().isNotEmpty) {
          final source = data['DefinitionURL'] ?? data['DefinitionSource'] ?? '';
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        if (relatedTopics != null && relatedTopics is List && relatedTopics.isNotEmpty) {
    ...
    // If all strategies fail, return null - will be handled by fallback message
