    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('Data Protection Principles',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Data Subject’s rights',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Data we gather at New Life Community Church, Tonyrefail',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Following is a list of our Partners –',
          ...
          const SizedBox(height: 16),
          const Text('How we use your Personal Data',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Who else can access your Personal Data',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('How we secure your data',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Cookies and other technologies we use',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text(
